...
export function createTransactionReceiptEntity(transactionHash: Bytes, receipt: ethereum.TransactionReceipt): TransactionReceipt {
...
export function handleUpdatedOevProxyBeaconSetWithSignedData(
  ...
  entity.value = event.params.value
  entity.timestamp = event.params.timestamp
  entity.parameters = [entity.beaconSetId.toHexString(), event.params.proxy.toHexString(), entity.updateId.toHexString(), entity.value.toString(), entity.timestamp.toString()]
...
export function handleUpdatedOevProxyBeaconWithSignedData(
  ...
  entity.value = event.params.value
  entity.timestamp = event.params.timestamp
  entity.parameters = [entity.beaconId.toHexString(), event.params.proxy.toHexString(), entity.updateId.toHexString(), entity.value.toString(), entity.timestamp.toString()]
...
export function handleWithdrew(event: WithdrewEvent): void {
  ...
  entity.parameters = [entity.oevProxy.toHexString(), event.params.oevBeneficiary.toHexString(), entity.amount.toString()]
